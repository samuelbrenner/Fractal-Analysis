...
%----------------------------------------------------------------------------------------
\section{An example of a fractal: the Koch snowflake (see Figure \ref{fig:kochcurve})}\label{fractalexample}\todo{rename this to reflect the inclusion of the Cantor set for comparison.}
