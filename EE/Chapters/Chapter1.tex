...
\begin{example}We can apply numerical techniques to verify the agreement of this definition with that established in Section \ref{intuitivedimension}. A computer program is described in \ref{AppendixA} \end{example}
